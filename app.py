...
RTR_TL = "GMAYORALM"   # cambia a "GMAYORALM" si Guillermo será TL
...
st.markdown(f"""
<style>
@import url('https://www.pngitem.com/pimgs/m/560-5600877_jose-cuervo-crow-logo-hd-png-download.png');
...
def show_main_app():
   ...
   # Botón de Asignar Roles para TL (GENÉRICO por equipo)
    ...
    st.image("https://www.pngitem.com/pimgs/m/560-5600877_jose-cuervo-crow-logo-hd-png-download.png", width=160)
